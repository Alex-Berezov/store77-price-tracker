...
export default function ProductError({ error, reset }: ErrorProps) {
  return (
    <div className="container flex min-h-[50vh] flex-col items-center justify-center py-12 text-center">
      ...
      <h1 className="mt-6 text-2xl font-bold sm:text-3xl">Ошибка загрузки товара</h1>

      <p className="mt-3 max-w-md text-muted-foreground">
        Произошла ошибка при загрузке информации о товаре. Пожалуйста, попробуйте ещё раз или
        вернитесь к каталогу.
      </p>
